...
class RegistrationForm(forms.Form):
    ...
    username = forms.CharField(max_length=30,
                               ...
                               label=_(u'username'))
    planet = forms.CharField(max_length=30,widget=forms.TextInput(attrs=attrs_dict),label=_(u'planet'))
    ...
    def clean_email(self):
        ...
        try:
            ...
            bad_domains = ['1.loldose.com','mintemail.com','mintemail.uni.cc','minte.1.vg','mintemails.info.tm','mint.us.to']
    
            email_domain = self.cleaned_data['email'].split('@')[1]
            if email_domain in bad_domains:
                raise forms.ValidationError(_(u'Domena tego adresu email została zablokowana .'))
