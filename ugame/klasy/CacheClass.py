...
from ugame.models.all import Budynki_p, Budynki_f, Badania_p, Badania_f, Flota_p, \
    Flota_f, Obrona_p, Obrona_f
...
class CacheClass():
    ...
    def save_all(self):
        for pl in self.cache_budynki_p:
            for bd in self.cache_budynki_p[pl]:
                # print "planeta:",pl,"numer idx:",bd,type(bd),self.cache_budynki_p[pl][bd].budynek.nazwa,self.cache_budynki_p[pl][bd].level
    ...
    def get_budynek_p(self, id_planety, id_budynek):
        ...
        if not self.cache_budynki_p.has_key(id_planety):self.cache_budynki_p[id_planety] = {}
    ...
    def get_budynek_f(self, id_planety, id_budynek):
        id_budynek = int(id_budynek)
        id_planety = int(id_planety)
        if not self.cache_budynki_f.has_key(id_planety):self.cache_budynki_f[id_planety] = {}
    ...
    def get_badanie_p(self, id_user, id_badanie):
        ...
        if not self.cache_badania_p.has_key(id_user):self.cache_badania_p[id_user] = {}
    ...
    def get_badanie_f(self, id_user, id_badanie):
        ...
        if not self.cache_badania_f.has_key(id_user):self.cache_badania_f[id_user] = {}
    ...
    def get_flota_p(self, id_planety, id_budynek):
        ...
        if not self.cache_flota_p.has_key(id_planety):self.cache_flota_p[id_planety] = {}
    ...
    def get_flota_f(self, id_planety, id_budynek):
        ...
        if not self.cache_flota_f.has_key(id_planety):self.cache_flota_f[id_planety] = {}
    ...
    def get_obrona_p(self, id_planety, id_budynek):
        ...
        if not self.cache_obrona_p.has_key(id_planety):self.cache_obrona_p[id_planety] = {}
    ...
    def get_obrona_f(self, id_planety, id_budynek):
        ...
        if not self.cache_obrona_f.has_key(id_planety):self.cache_obrona_f[id_planety] = {}
