...
from ugame.funkcje import check_is_planet, check_ship_request, check_surowce, getCzasLotu, get_ship_request, \
    get_speed, \
    get_zuzycie_deuteru, odleglosc
...
class CMS(object):
    ...
    def site_send(self):
        ...
        flota_row = Fleets.objects.create(fleet_owner=self.game.user, fleet_mission=2, fleet_amount=fleet_amount,
                                          ...
                                          fleet_resource_deuterium=zab_deu,
