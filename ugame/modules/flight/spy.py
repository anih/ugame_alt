...
from ugame.funkcje import Output, check_is_planet, check_ship_request, getCzasLotu, get_ship_request, get_speed, \
    get_zuzycie_deuteru, is_planet_owner, odleglosc
...
class CMS(object):
    ...
    def site_send(self):
        ...
        flota_row = Fleets.objects.create(fleet_owner=self.game.user, fleet_mission=6, fleet_amount=fleet_amount,
